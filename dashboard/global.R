...
error_1_table <- diagnosis2 %>%
  ...
  summarise(error1 = n())%>%
  mutate(percentage_1 = round(error1/sum(error1)*100, digits = 2))
error_1_table
...
error_2_table <- diagnosis2 %>%
  ...
  summarise(error2 = n())%>%
  mutate(percentage_2 = round(error2/sum(error2)*100, digits = 2))
error_2_table
...
error_3_table <- diagnosis2 %>%
  ...
  summarise(error3 = n())%>%
  mutate(percentage_3 = round(error3/sum(error3)*100, digits = 2))
error_3_table
...
error_4_table <- diagnosis2 %>%
  ...
  summarise(error4 = n())%>%
  mutate(percentage_4 = round(error4/sum(error4)*100, digits = 2))
error_4_table
...
error_5_table <- diagnosis2 %>%
  ...
  summarise(error5 = n())%>%
  mutate(percentage_5 = round(error5/sum(error5)*100, digits = 2))
error_5_table
